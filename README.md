...
│   └── ...
│
├── extract.py   # Script to process audio and create features.jsonl
├── train.py          # Script to train the model from features.jsonl
├── predictor.py       # Script to test a new audio file
│
